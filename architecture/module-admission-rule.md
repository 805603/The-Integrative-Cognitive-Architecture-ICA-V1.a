...
## Coherence Threshold
The architecture maintains a minimum coherence threshold that all modules must meet. This threshold adapts based on context, load, and regulatory activity. Modules that fall below the threshold are modified, delayed, or discarded.
...
The reflex arc provides embodied feedback that influences module admission. If grounding signals weaken or completion cues fail to appear, the architecture interprets this as a destabilizing pattern and blocks the module from entering.
